...
const Nav = () => {
  ...
  const { data: cartData = [] } = useGetCartProductQuery(email, {
    skip: !email,
  });
  const { data: wishlistData = [] } = useGetWishlistProductQuery(email, {
    skip: !email,
  });
...
const wishlistCount = wishlistData?.length || 0;
  ...
  const adminUl = (
    <>
      ...
      >
        ...
        <li className=" ">
          <div className="flex gap-2 flex-row">
            <Link to="/admin/managecoupons"> Manage Coupon</Link>{" "}
          </div>
        </li>
        <li className=" ">
          <div className="flex gap-2 flex-row">
            <Link to="admin/userlist"> User Management</Link>{" "}
          </div>
        </li>
  ...
  return (
    <div className="  bg-white z-[999] border-b-2 mx-auto py-4 ">
      <div className="navbar  sticky top-0 px-0 gap-28 bg-base-100">
                ...
                <div className="relative">
                  <GoHeart
                    className={`transition-transform duration-300 ${
                      animateWishList ? "scale-125" : "scale-100"
                    }`}
                  />
